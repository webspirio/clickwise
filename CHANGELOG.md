...
All notable changes to the Rybbit Analytics for WordPress plugin will be documented in this file.
...
### Added
- **Initial Release**: First stable version of Rybbit Analytics for WordPress
